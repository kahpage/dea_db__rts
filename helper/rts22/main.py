...
def main():
    ...
    for i, base_url in enumerate(
        [
            "https://web.archive.org/web/20260417090718id_/https://reitaisai.com/rts22/accepted-circle-list/",
            "https://web.archive.org/web/20260511032221id_/https://reitaisai.com/rts22/accepted-additional-circles-list/"
        ]
    ):
        ...
        if match:
            ...
            for entry in data:
                ...
                circle_media = remove_span(entry.get("media", "").strip())
                circle_seijin = remove_span(entry.get("seijin", "").strip())
                ...
                if circle_media:
                    if circle_seijin == "あり":
                        comments_list.append(f"Media: {circle_media}, with adult content")
                    else:
                        comments_list.append(f"Media: {circle_media}")
