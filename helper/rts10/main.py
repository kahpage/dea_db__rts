...
def main():
    ...
    # Official source
    # Parse the HTML content across the 11 disposition pages to extract circle information
    circles_info = []
    for i in range(1, 12):
        official_soup = retrieve_soup_fetch_if_needed(
            f"https://web.archive.org/web/2013/http://reitaisai.com/list_disposition{i}/",
            f"raw_official_{i}.html",
            f"https://web.archive.org/web/2/http://reitaisai.com/list_disposition{i}/",
        )
        table = official_soup.find("table", id="circlelist")
        if not table:
            continue
    ...
    print(f"Found {len(circles_info)} circles across 11 official source pages")
    ...
    secondary_links = [
        "https://thwiki.cc/%E5%8D%9A%E4%B8%BD%E7%A5%9E%E7%A4%BE%E4%BE%8B%E5%A4%A7%E7%A5%AD/%E7%AC%AC10%E5%B1%8A%E6%91%8A%E4%BD%8D/A%EF%BD%9EM%E9%83%A8%E5%88%86",
        "https://thwiki.cc/%E5%8D%9A%E4%B8%BD%E7%A5%9E%E7%A4%BE%E4%BE%8B%E5%A4%A7%E7%A5%AD/%E7%AC%AC10%E5%B1%8A%E6%91%8A%E4%BD%8D/N%EF%BD%9EW%E9%83%A8%E5%88%86",
        "https://thwiki.cc/%E5%8D%9A%E4%B8%BD%E7%A5%9E%E7%A4%BE%E4%BE%8B%E5%A4%A7%E7%A5%AD/%E7%AC%AC10%E5%B1%8A%E6%91%8A%E4%BD%8D/%E3%81%82%EF%BD%9E%E3%81%99%E9%83%A8%E5%88%86",
        "https://thwiki.cc/%E5%8D%9A%E4%B8%BD%E7%A5%9E%E7%A4%BE%E4%BE%8B%E5%A4%A7%E7%A5%AD/%E7%AC%AC10%E5%B1%8A%E6%91%8A%E4%BD%8D/%E3%81%9B%EF%BD%9E%E3%81%AE%E9%83%A8%E5%88%86",
    ]
